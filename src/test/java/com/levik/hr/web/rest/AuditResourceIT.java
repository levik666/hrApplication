...
import com.levik.hr.HrApplicationApp;
import com.levik.hr.config.TestSecurityConfiguration;
import com.levik.hr.config.audit.AuditEventConverter;
import com.levik.hr.domain.PersistentAuditEvent;
import com.levik.hr.repository.PersistenceAuditEventRepository;
import com.levik.hr.security.AuthoritiesConstants;
import com.levik.hr.service.AuditEventService;
...
@SpringBootTest(classes = { HrApplicationApp.class, TestSecurityConfiguration.class })
@Transactional
